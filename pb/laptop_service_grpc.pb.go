...
const (
	...
	LaptopService_TotalPriceLaptops_FullMethodName = "/LaptopService/TotalPriceLaptops"
	LaptopService_ChatMSLaptops_FullMethodName     = "/LaptopService/ChatMSLaptops"
)
...
type LaptopServiceClient interface {
	...
	TotalPriceLaptops(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TotalPriceLaptopRequest, TotalPriceLaptopResponse], error)
	ChatMSLaptops(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ChatMsRequest, ChatMsResponse], error)
}
...
func (c *laptopServiceClient) TotalPriceLaptops(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[TotalPriceLaptopRequest, TotalPriceLaptopResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[1], LaptopService_TotalPriceLaptops_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[TotalPriceLaptopRequest, TotalPriceLaptopResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LaptopService_TotalPriceLaptopsClient = grpc.ClientStreamingClient[TotalPriceLaptopRequest, TotalPriceLaptopResponse]

func (c *laptopServiceClient) ChatMSLaptops(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ChatMsRequest, ChatMsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[2], LaptopService_ChatMSLaptops_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ChatMsRequest, ChatMsResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LaptopService_ChatMSLaptopsClient = grpc.BidiStreamingClient[ChatMsRequest, ChatMsResponse]
...
type LaptopServiceServer interface {
	...
	TotalPriceLaptops(grpc.ClientStreamingServer[TotalPriceLaptopRequest, TotalPriceLaptopResponse]) error
	ChatMSLaptops(grpc.BidiStreamingServer[ChatMsRequest, ChatMsResponse]) error
...
func (UnimplementedLaptopServiceServer) TotalPriceLaptops(grpc.ClientStreamingServer[TotalPriceLaptopRequest, TotalPriceLaptopResponse]) error {
	return status.Errorf(codes.Unimplemented, "method TotalPriceLaptops not implemented")
}
func (UnimplementedLaptopServiceServer) ChatMSLaptops(grpc.BidiStreamingServer[ChatMsRequest, ChatMsResponse]) error {
	return status.Errorf(codes.Unimplemented, "method ChatMSLaptops not implemented")
}
...
func _LaptopService_TotalPriceLaptops_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LaptopServiceServer).TotalPriceLaptops(&grpc.GenericServerStream[TotalPriceLaptopRequest, TotalPriceLaptopResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LaptopService_TotalPriceLaptopsServer = grpc.ClientStreamingServer[TotalPriceLaptopRequest, TotalPriceLaptopResponse]

func _LaptopService_ChatMSLaptops_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LaptopServiceServer).ChatMSLaptops(&grpc.GenericServerStream[ChatMsRequest, ChatMsResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LaptopService_ChatMSLaptopsServer = grpc.BidiStreamingServer[ChatMsRequest, ChatMsResponse]
...
var LaptopService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "TotalPriceLaptops",
			Handler:       _LaptopService_TotalPriceLaptops_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "ChatMSLaptops",
			Handler:       _LaptopService_ChatMSLaptops_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
